...
window.addEventListener("scroll", () => {
  ...
  if (window.scrollY > 200) {
    toTopButton.classList.add("show"); // Show the button
  } else {
    toTopButton.classList.remove("show"); // Hide the button
  }
});
  ...
  events: {
    e: {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "664fb0cf9f39559c823336b7|6cb83937-5ab4-fb05-6f19-cd8e7979fb03",
      },
      targets: [],
      config: {
        loop: false,
    ...
    "e-3": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "664fb0cf9f39559c823336b7|d0e857d3-174a-15c5-a865-f9be765fc868",
      },
      targets: [],
      config: {
        loop: false,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".s-services__hover-icon",
                  selectorGuids: ["559af8e8-42bb-6e9c-e254-155d3cbc7b18"],
                },
                widthValue: 0,
                widthUnit: "px",
                heightUnit: "PX",
